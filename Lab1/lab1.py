...
arr1_buf = cl.Buffer(context, cl.mem_flags.READ_ONLY | cl.mem_flags.COPY_HOST_PTR, hostbuf=matrix1.ravel().astype(numpy.float32))
arr2_buf = cl.Buffer(context, cl.mem_flags.READ_ONLY | cl.mem_flags.COPY_HOST_PTR, hostbuf=matrix2.ravel().astype(numpy.float32))
...
worker.matmult(queue, (global_work_size,global_work_size), (tile_size,tile_size), 
